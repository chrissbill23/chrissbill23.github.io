...
$.fn.treeSelection = function(options) {
    ...
    let obj = $('<span>')
		.attr("id", "treeSelectorContainer")
        .attr('style', this.attr('style'))
        .attr('class', this.attr('class'))
        .addClass('treeSelector');
	let placeholder = this.find(">:first-child");
	...
	function reportWindowSize() {
		var selector = $('#treeSelectorContainer');
		$('.treeSelection')
		.css({
			'width': selector.css('width'),
			'top': (selector.position().top+parseInt(selector.css('height'))),
